...
namespace TrainsClassLibraryFile
{
    public class CRUDForTrainMaster
    {
        ...
        public void TrainSearchByTarinNumber(int Trainnumber)
        {
            var trn = trainMasterContext.Trains.Where(tr => tr.TrainNo == Trainnumber).FirstOrDefault();
            if (trn != null)
            {
        ...
        public void TrainSearchByTarinNumberWithDay(int Trainnumber)
        {
        ...
        public void AllTrainList()
        {
            ...
            if(alltrn.Count > 0)
            {
                foreach(var tr in alltrn)
                {
                    ...
                    Console.WriteLine();
                    Console.WriteLine("-----------------------------------------------------");
                    Console.WriteLine("Train Avilable for days");
